...
1.INTRODUCTION Welcome to use Flashlight Detective Widget! Your use of Product is subject to these Terms (“Service” or “Our Service”).

Flashlight Detective Widget is an application that turns the camera flash into a pocket flashlight. The idea isn't very original, but the application is well-made, simple and ad-free.

Your use of Flashlight Detective Widget is subject to the terms and conditions of these Terms of Use (“Terms”). Please read these Terms carefully.

You must comply with these Terms in your use of Flashlight Detective Widget and only use Flashlight Detective Widget as permitted by applicable laws and regulations, wherever you may be when you use it. You must review these Terms to understand how you can and cannot use Flashlight Detective Widget. If you do not agree to these Terms, you must not download or install or otherwise use Flashlight Detective Widget.
...
2.CONTRACTING ENTITY By downloading, installing and using Flashlight Detective Widget, you are agreeing to be bound by these Terms between you and Flashlight Detective Widget Team (“We”, “Our” and “Us”).
...
5.SCOPE OF LICENSE Although we continue to own Flashlight Detective Widget, after your acceptance of these Terms you will have certain rights to use Flashlight Detective Widget during the entire time period when Flashlight Detective Widget is installed on your mobile device. All rights not expressly granted to you are retained by us. These Terms govern any releases, revisions, updates or enhancements to Flashlight Detective Widget that we may make available to you.

You may install, use, display and run Flashlight Detective Widget in a personal computer (“Device”) solely for non-commercial purposes and in accordance with these Terms. Installation, use, display or operation of Flashlight Detective Widget for commercial purposes is forbidden.

You shall have the right to receive new features to and versions of Flashlight Detective Widget as we, in our sole discretion, make such features and versions available. In order to optimize Flashlight Detective Widget, and to provide you with the most current version of Flashlight Detective Widget, you agree Flashlight Detective Widget can automatically download and install new updates and versions of the Flashlight Detective Widget as they are made available by us in our sole discretion. You agree to receive and permit us to deliver such new updates and versions to your mobile device. Additionally, we may modify these Terms to reflect such updates and versions and you agree to such updated terms.

You may not copy, modify, reverse compile, reverse engineer or extract source codes from Flashlight Detective Widget, except to the extent that we may not prohibit you from doing so under applicable laws or regulations or you have our prior written consent to do so. Where applicable laws or regulations entitle you to reverse compile or extract source codes from Flashlight Detective Widget, you will first contact us to request the information you need.
...
a)the collection of the information as how you use Flashlight Detective Widget (such as the time when you install Flashlight Detective Widget, version of Flashlight Detective Widget you are using, how you use the various functions and features that available to you), the information about your mobile device (such asthe operating system, hardware version, device settings, device identifiers) and your communication with us
...
10.TERMINATION These Terms will apply to your use of Flashlight Detective Widget and Our Service until access to the relevant services is terminated by either you or us.
